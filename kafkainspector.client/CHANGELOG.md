...
- Create Angular project with ng: `ng new kafkainspector.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`kafkainspector.client.esproj`).
